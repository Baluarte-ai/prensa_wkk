...
# Límite OK
tk.Label(frame_params_grid, text="Fuerza Mínima OK:", font=("Helvetica", 10),
...
# Dropdown de Unidad
combo_unidad = ttk.Combobox(frame_params_grid, values=["kg", "N"], width=4, font=("Helvetica", 10), state="readonly")
combo_unidad.set("kg")
combo_unidad.grid(row=1, column=2, pady=2, padx=(4, 0), sticky="w")
